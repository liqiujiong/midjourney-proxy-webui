export default {
  ...
  'pages.account.isVerticalDomain': '开启出图划分',
  'pages.account.verticalDomainIds': '出图划分配置',
  ...
  'pages.setting.isVerticalDomain': '开启出图划分',
  'pages.setting.isVerticalDomainTips': '开启出图划分绘画，会计算 promat 词条，然后根据词条分配给对应的账号绘画，如果没有匹配到账号，则分配到未开启出图划分的账号绘画',
